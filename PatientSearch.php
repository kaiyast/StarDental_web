       ...
       <?php  include('menubar.php'); 	 ?>
        ...
        <div class="col-md-9 col-lg-10 main">
				...
				<div class="col-md-12">
					...
					<form action="PatientSearch.php?redirect=<?php echo $redirect; ?>" method="post" enctype="multipart/form-data" >
							...
							if($checksearch == 1)
								...
								while($row = mysqli_fetch_array($result)) {
									...
									'
									   <tr>
											<td>
												<img style="height:150px; width:100%;" src="patient/'.$row['HN'].'/useravata.jpg" class="pull-right img-responsive img-rounded">
												<br><center> HN-'.printid($row['HN']).'<center>
											</td>
											
											<td>
												<p style="margin-top:3px;">'.$row['title'].' '.$row['name'].' '.$row['lastname'].'</p>
												<p style="margin-top:3px;"> เบอร์โทรศัพท์  : '.$row['phone'].'</p>
												<p style="margin-top:3px;"> ประวัติการแพ้ยา : '.$medical_history.'</p>
												<p style="margin-top:3px;"> โรคประจำตัว : '.$disease.'</p>
									...
									{
										echo '	<a href="'.$redirect.'.php?search_output='.$row['HN'].'&searchsuccess=1"><button  class="col-md-3 btn btn-success tablebtn" type="button">เลือก</button></a> ';
									}
									else
									{
										$treatment_history = $_SESSION["treatmenthistory_id"];
										echo '	<a href="TreatmentHistoryController.php?action=changepatient&searchoutput='.$row['HN'].'&treatment_history='.$treatment_history.'"><button class="col-md-3 btn btn-success tablebtn" type="button">เลือก</button></a> ';
									}	
