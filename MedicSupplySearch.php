       ...
       <?php  include('menubar.php'); 	 ?>
        ...
        <div class="col-md-9 col-lg-10 main">
				...
				<div class="col-md-12">
					...
					<form action="MedicSupplySearch.php?redirect=<?php echo $redirect; ?>" method="post" enctype="multipart/form-data" >
							...
							if($checksearch == 1)
								...
								while($row = mysqli_fetch_array($result)) {
									...
									'
									   <tr>
											<td>
												<img style="height:150px; width:100%;" src="medicsupply/'.$row['id'].'/supply.jpg" class="pull-right img-responsive img-rounded">
												<br><center> MS-'.printid($row['id']).'<center>
											</td>
											<td>
											
											<p style="margin-top:3px; font-size:200%">'.$row['name'].'</p>
											<p style="margin-top:3px;"> รายละเอียด  : '.$row['detail'].'</p>
											<p style="margin-top:3px;"> จำนวนที่เหลือ  : '.$row['amount'].' '.$row['unit'].'</p>
									...
									else
									{
										...
										echo '	<a href="TreatmentHistoryController.php?action=addmedicsupply&searchoutput='.$row['id'].'&treatment_history='.$treatment_history.'"><button class="col-md-3 btn btn-success tablebtn" type="button">เลือก</button></a> ';
									}	
